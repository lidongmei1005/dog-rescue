    ...
    <div>
      ...
      <section className="bg-amber-50 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "1", icon: "🔍", title: "Browse Dogs", desc: "Explore our gallery of dogs looking for their forever homes" },
              { step: "2", icon: "📝", title: "Apply", desc: "Submit an adoption application — it takes just a few minutes" },
              { step: "3", icon: "🏠", title: "Welcome Home!", desc: "We'll review your application and set up a meet-and-greet" },
            ].map((s) => (
